...
b=b+">";b+='<div class="weatherTemp"><a href="http://weather.com/weather/hourbyhour/graph/Chicago+IL+60607:4:US">'+c.item.condition.temp+"&deg;</div>";b+='<div class="weatherDesc">'+c.item.condition.text+"</div>";e.highlow&&(b+='<div class="weatherRange">High: '+g.high+"&deg; Low: "+g.low+"&deg;</div>");e.wind&&(b+='<div class="weatherWind">Wind: '+a+" "+c.wind.speed+c.units.speed+"</div>");e.humidity&&(b+='<div class="weatherHumidity">Humidity: '+
...
'<div class="weatherError">City not found</div>';b+="</a></div>";p="odd"==p?"even":"odd";f.append(b)},u=function(f){d=new Date;return r=new Date(d.toDateString()+" "+f)}})}})(jQuery);
...
//Clock code borrowed and stripped from Currently without permission
var Clock={$el:{second:$("#secondhand"),minute:$("#minutehand"),hour:$("#hourhand")},timeParts:function(){var e=new Date,t=e.getHours();if(t>12){t=t-12}else if(t===0){t=12}return{date:e.getDate(),hour:t,minute:Clock.appendZero(e.getMinutes()),second:Clock.appendZero(e.getSeconds()),secondAngle:e.getSeconds()*6,minuteAngle:e.getMinutes()*6,hourAngle:(e.getHours()%12+e.getMinutes()/60)*30}},appendZero:function(e){if(e<10){return"0"+e}return e},transformTemplate:function(e){return"rotate("+e+",50,50)"},refresh:function(e){var t=Clock.timeParts(e);var n=Clock._parts||{};_.each(["hour","minute","second"],function(e){if(t[e]!==n[e]){Clock.$el[e].attr("transform",Clock.transformTemplate(t[e+"Angle"]))}});Clock._parts=t},start:function(e){function t(){var n=500;Clock.refresh(e);Clock._running=setTimeout(function(){window.requestAnimationFrame(t)},n)}if(Clock._running){clearInterval(Clock._running)}t()}}